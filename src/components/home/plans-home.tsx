    ...
    <section className="bg-black min-h-screen py-16 px-4 mt-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-12">
          <Button className="bg-[#FF4500] hover:bg-[#FF4500]/90 text-white px-8 py-6 text-xs md:text-base rounded-full w-full max-w-[300px]">
            <Link href="https://wa.me/55999991443864">ENTRE EM CONTATO</Link>
          </Button>
        </div>
      </div>
    </section>
